...
| `codex/show-project-lms-document-structure` | ✅ Done (готово к merge) | 2025-10-11 12:25 UTC: CI run 18429063428, Integration run 18429063426 завершились успешно | CI: OK (run 18429063428); Integration: OK (run 18429063426) | Смёржить PR #6 в `main` и удалить ветку |
