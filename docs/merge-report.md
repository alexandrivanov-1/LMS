...
| `codex/show-project-lms-document-structure` | In progress | 2025-10-11 12:05 UTC: ветка обновлена от `main`, повторный запуск Actions запланирован в текущей сессии | — | Открыть PR, дождаться свежих прогонов CI/Integration и после зелёного статуса смержить в `main` |
