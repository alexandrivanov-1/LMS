...
| `codex/show-project-lms-document-structure` | ✅ Done (готово к merge) | 2025-10-11 12:40 UTC: CI run 18429094124, Integration run 18429094130 завершились успешно | CI: OK (run 18429094124); Integration: OK (run 18429094130) | Смёржить PR #6 в `main` и удалить ветку |
