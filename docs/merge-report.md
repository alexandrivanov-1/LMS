...
| `codex/show-project-lms-document-structure` | ✅ Done (готово к merge) | 2025-10-11 12:48 UTC: свежие прогоны CI и Integration по PR #6 завершились успешно | CI/Integration: OK (см. Actions для коммита 7b7a178) | Смёржить PR #6 в `main` и удалить ветку |
