...
| `codex/show-project-lms-document-structure` | ✅ Done (готово к merge) | 2025-10-11 12:32 UTC: CI run 18429078004, Integration run 18429078000 завершились успешно | CI: OK (run 18429078004); Integration: OK (run 18429078000) | Смёржить PR #6 в `main` и удалить ветку |
